...
- (void)gsub:(NSMutableString *)target block:(NSString *(^)(OnigResult *result, BOOL *stop))block;
- (void)gsub:(NSMutableString *)target block:(NSString *(^)(OnigResult *result, BOOL *stop))block range:(NSRange)range;
